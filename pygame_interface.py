...
class PygameInterface:
    ...
    class Zone():
        def __init__(self,name,font,polygon,light,pos_x,pos_y,width,height):
            ...
            self.light = light
            self.text_render = font.render(name + self.light.address, True, (0, 0, 0))
            self.button = PygameInterface.Button(self,pos_x,pos_y,width,height,self.text_render)
    ...
    def create_buttons(self):
        ...
        # Button New Zone
        text_zones_default = font.render('New Zone', True, (0, 0, 0))
        text_zones_changed = font.render('Set Zone', True, (0, 0, 0))
        ...
        text_tracking_default = font.render('Start Tracking', True, (0, 0, 0))
        text_tracking_changed = font.render('Stop Tracking', True, (0, 0, 0))
        ...
        # Button Load Zones
        text_load_zones = font.render('Load Zones', True, (0, 0, 0))
        ...
        # Button Save Zones
        text_save_zones = font.render('Save Zones', True, (0, 0, 0))
        ...
        # Button Delete Zones
        text_flush = font.render('Delete Zones', True, (0, 0, 0))
    ...
    def add_zone(self, zone_polygon,zone_light):
        """add a zone on the interface"""
        self.zones[zone_light] = zone_polygon
    ...
    def draw_zones(self):
        ...
        for light,polygon in self.zones:
    ...
    def create_zone_recap(self):
        ...
        zone_recap = pygame.rect.Rect(self.width - zone_recap_width, 0, zone_recap_height, zone_recap_width)
        return zone_recap

    def draw_zone_recap(self):
        """draws the zone recap on the interface"""
        pygame.draw.rect(self.screen, (200, 200, 200), self.zone_recap)
        button_to_draw = []
        for zone in self.zones:
            button_to_draw.append(zone.button)
